...
The template may show a failed first deployment until its domain, OAuth app, and required secrets are filled in. This sequence is inherent to GitHub’s exact callback URL requirement; describe it clearly in the template overview.
